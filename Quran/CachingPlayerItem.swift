    ...
    func playerItem(_ playerItem: CachingPlayerItem, didFinishDownloadingData data: Data){
        ...
        if let savedUrl = self.verse.getSavedUrl(){
            do{
                ...
                self.verse.isDownloaded = true
            } catch{
                print("Can't Download \(error.localizedDescription)")
            }
        }
    }
...
//downloaded from https://github.com/neekeetab/CachingPlayerItem/blob/master/CachingPlayerItem.swift
